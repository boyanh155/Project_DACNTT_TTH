  ...
  <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
        ...
        <body>
            <div class="Employee-Form col-8 ml-a mr-a">
                ...
                <form action="<%=request.getContextPath()%>/sign-up/verify" method="POST" id="registerForm">
                    ...
                    <div class="form-row mt-4 flex-column align-center">
                        <div class="col-md-8 justify-content-center">
                            ...
                            <input id="gmail" name="gmail" type="text" class="form-control" required placeholder="Your gmail">
                            <p id="mess">${mess}</p>
                        </div>
                        <div class="col-md-8">
